<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"application/admin\view\manager\add.html";i:1588751899;s:64:"D:\wwwroot\178\wwwroot\application\admin\view\Public\header.html";i:1588911510;s:62:"D:\wwwroot\178\wwwroot\application\admin\view\Public\left.html";i:1588817206;s:64:"D:\wwwroot\178\wwwroot\application\admin\view\Public\footer.html";i:1588130548;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
	...
	<div class="layui-body">
		<div class="layui-tab layui-tab-brief" lay-filter="tab">
			<ul class="layui-tab-title">
				<li><a href="<?php echo url('Manager/Index'); ?>">系统用户列表</a></li>
				<li class="layui-this"><a href="<?php echo url('Manager/Add'); ?>">系统用户添加</a></li>
			</ul>
					...
					<form action="" method="post" class="layui-form" onSubmit="return check_manager_add(this);">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<select name="role_id" lay-filter="model" lay-verify="required">
									<option value="">请选择管理角色</option>
									<?php $_result=get_table_list('role','','id,role_name');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vs): $mod = ($i % 2 );++$i;?>
										<option value="<?php echo $vs['id']; ?>" <?php if($vs['id'] == $v['role_id']): ?> selected<?php endif; ?>><?php echo $vs['role_name']; ?></option>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="realname" value="<?php echo $v['realname']; ?>" lay-verify="required" placeholder="请输入管理姓名" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="username" value="<?php echo $v['username']; ?>" required lay-verify="required" placeholder="请输入用户名" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="password"  value="" lay-verify="required" placeholder="请输入密码" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="repassword" value="" lay-verify="required" placeholder="请输入确认密码" class="layui-input">
							</div>
						</div>
