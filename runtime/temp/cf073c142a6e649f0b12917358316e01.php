<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:37:"application/admin\view\model\add.html";i:1588751899;s:76:"F:\phpStudy\PHPTutorial\WWW\think5\application\admin\view\Public\header.html";i:1588911510;s:74:"F:\phpStudy\PHPTutorial\WWW\think5\application\admin\view\Public\left.html";i:1588817206;s:76:"F:\phpStudy\PHPTutorial\WWW\think5\application\admin\view\Public\footer.html";i:1588130548;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
	...
	<div class="layui-body">
		<div class="layui-tab layui-tab-brief" lay-filter="tab">
			<ul class="layui-tab-title">
				<li><a href="<?php echo url('Model/Index'); ?>">模型列表</a></li>
				<li class="layui-this"><a href="<?php echo url('Model/Add'); ?>">模型添加</a></li>
			</ul>
					...
					<form action="" method="post" class="layui-form">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="model_name" value="<?php echo $v['model_name']; ?>" required lay-verify="required" placeholder="请输入模型名称" class="layui-input">
							</div>
						</div>

						<div class="layui-form-item">
							<label class="layui-form-label">包含字段</label>
							<div class="layui-input-inline">
								<div class='layui-col-md9'>
									<?php echo $model_fields; ?>
								</div>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="model_c" id="model_c" value="<?php echo get_my_value($v['model_c'],'News'); ?>" lay-verify="required" placeholder="请输入控制器" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="model_a" id="model_a" value="<?php echo get_my_value($v['model_a'],'Index'); ?>" lay-verify="required" placeholder="请输入操作方法" class="layui-input">
							</div>
						</div>

						<div class="layui-form-item">
							<label class="layui-form-label">模型排序</label>
							<div class="layui-input-inline" style="width: 120px;">
								<input type="text" name="disorder" value="<?php echo $v['disorder']; ?>" placeholder="请输入模型排序" class="layui-input" style="width: 120px;">
							</div>
							数字越小越在前
						</div>
