<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:38:"application/index\view\view\index.html";i:1592531153;s:76:"F:\phpStudy\PHPTutorial\WWW\think5\application\index\view\public\header.html";i:1592538099;s:76:"F:\phpStudy\PHPTutorial\WWW\think5\application\index\view\public\footer.html";i:1592476974;}*/ ?>
<?php
...
<?php endif; $_result=get_view($id);if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="container-fluid">    <div class="content">        <div class="hzpptit">            <div class="hzpptit_l">                <div class="hzpptit2">                    <h4><?php echo $v['title']; ?></h4>                </div>                <div class="hzpptit3">                    <?php echo get_content($v['content']); ?>                </div>                <div class="hzpptit4">                    <ul>                        <li><em>上一页</em><span><a href="#">是产业的发展历程及发展动向的分析和研究以及对世界各国和全国各地老产业有关政策.....</a></span></li>                        <li><em>下一页</em><span><a href="#">共同发展粤港澳大湾区城市群寄予了厚望，到访期间，他详细了解了合成生物学的最新进展共同发展粤港澳大湾区城市群寄予了厚望，到访期间，他详细了解了合成生物学的最新进展</a></span></li>                    </ul>                </div>            </div>            <div class="hzpptit_r">                <div class="hzpptit1">                    <table border="1" cellspacing="1" cellpadding="" bordercolor="#ebebeb">                        <?php if(get_news(1,9,0,0,'*',2,0,'desc')): ?>                        <tr>                            <?php $_result=get_news(1,9,0,0,'*',2,0,'desc');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>                            <td><a href="<?php echo url('/index/view/index',"id=".$v['id'].""); ?>"><img src="<?php echo $v['img1']; ?>"/><p><?php echo $v['title']; ?></p></a></td>                            <?php endforeach; endif; else: echo "" ;endif; ?>                        </tr>                        <?php endif; if(get_news(1,9,0,0,'*',2,2,'desc')): ?>                        <tr>                            <?php $_result=get_news(1,9,0,0,'*',2,2,'desc');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>                            <td><a href="<?php echo url('/index/view/index',"id=".$v['id'].""); ?>"><img src="<?php echo $v['img1']; ?>"/><p><?php echo $v['title']; ?> </p></a></td>                            <?php endforeach; endif; else: echo "" ;endif; ?>                        </tr>                        <?php endif; if(get_news(1,9,0,0,'*',2,4,'desc')): ?>                        <tr>                            <?php $_result=get_news(1,9,0,0,'*',2,4,'desc');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>                            <td><a href="<?php echo url('/index/view/index',"id=".$v['id'].""); ?>"><img src="<?php echo $v['img1']; ?>"/><p><?php echo $v['title']; ?> </p></a></td>                            <?php endforeach; endif; else: echo "" ;endif; ?>                        </tr>                        <?php endif; if(get_news(1,9,0,0,'*',2,6,'desc')): ?>                        <tr>                            <?php $_result=get_news(1,9,0,0,'*',2,6,'desc');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>                            <td><a href="<?php echo url('/index/view/index',"id=".$v['id'].""); ?>"><img src="<?php echo $v['img1']; ?>"/><p><?php echo $v['title']; ?> </p></a></td>                            <?php endforeach; endif; else: echo "" ;endif; ?>                        </tr>                        <?php endif; if(get_news(1,9,0,0,'*',2,8,'desc')): ?>                        <tr>                            <?php $_result=get_news(1,9,0,0,'*',2,8,'desc');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>                            <td><a href="<?php echo url('/index/view/index',"id=".$v['id'].""); ?>"><img src="<?php echo $v['img1']; ?>"/><p><?php echo $v['title']; ?> </p></a></td>                            <?php endforeach; endif; else: echo "" ;endif; ?>                        </tr>                        <?php endif; if(get_news(1,9,0,0,'*',2,10,'desc')): ?>                        <tr>                            <?php $_result=get_news(1,9,0,0,'*',2,10,'desc');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>                            <td><a href="<?php echo url('/index/view/index',"id=".$v['id'].""); ?>"><img src="<?php echo $v['img1']; ?>"/><p><?php echo $v['title']; ?> </p></a></td>                            <?php endforeach; endif; else: echo "" ;endif; ?>                        </tr>                        <?php endif; ?>                    </table>                    <span><h4>合作品牌</h4></span>                </div>            </div>        </div>    </div></div><?php endforeach; endif; else: echo "" ;endif; ?><div class="container-fluid fooder">
    <div class="content">
        <div class="ftbd flgo">
