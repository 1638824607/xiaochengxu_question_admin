<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"application/admin\view\manager\index.html";i:1588834775;s:64:"D:\wwwroot\178\wwwroot\application\admin\view\Public\header.html";i:1588911510;s:62:"D:\wwwroot\178\wwwroot\application\admin\view\Public\left.html";i:1588817206;s:64:"D:\wwwroot\178\wwwroot\application\admin\view\Public\footer.html";i:1588130548;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-side layui-bg-black">
	...
	<div class="layui-tab layui-tab-brief" lay-filter="tab">
		<ul class="layui-tab-title">
			<li class="layui-this"><a href="<?php echo url('Manager/Index'); ?>">系统用户列表</a></li>
			<li><a href="<?php echo url('Manager/Add'); ?>">系统用户添加</a></li>
		</ul>
				...
				<table class="layui-table">
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
						<tr>
							...
							<td><?php echo get_zd_name('role_name','role','id='.$v['role_id'].''); ?></td>
							<td><?php echo $v['realname']; ?></td>
							<td><?php echo $v['username']; ?></td>
							<td>
								<?php if($v['id']>1){if($v['status']==1){?>
									<a href='<?php echo url('Manager/Audit?id='.$v['id']); ?>'><i class='fa fa-toggle-on' title="点击关闭"></i></a>
									<?php }else{?>
									<a href='<?php echo url('Manager/Audit?id='.$v['id']); ?>'><i class='fa fa-toggle-off' title="点击开启"></i></a>
									<?php }}else{?>
									<i class='fa fa-toggle-on'></i>
								<?php }?>
							</td>
							<td>
								<a href='<?php echo url('Manager/Add?id='.$v['id']); ?>'  class='layui-btn layui-btn-xs'>修改</a>
								<?php if($v['id']>1){?>
								<a href='<?php echo url('Manager/Del?id='.$v['id']); ?>' onclick='return confirm("您确定要删除吗？")' class='layui-btn layui-btn-xs layui-btn-danger' title='删除'>删除</a>
								<?php }?>
							</td>
						</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
