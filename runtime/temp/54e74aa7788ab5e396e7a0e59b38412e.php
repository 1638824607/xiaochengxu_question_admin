<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:38:"application/index\view\show\index.html";i:1592539166;s:76:"F:\phpStudy\PHPTutorial\WWW\think5\application\index\view\public\header.html";i:1592538099;s:76:"F:\phpStudy\PHPTutorial\WWW\think5\application\index\view\public\footer.html";i:1592476974;}*/ ?>
<?php
...
<div class="container-fluid">
    ...
    <div class="content">
        ...
        <div class="hzpptit">
            ...
            <div class="hzpptit_l">
                <h3 class="newstt1"><?php echo $v['title']; ?></h3>
                <div class="newsms">
                    <code><img src="/public/static/images/nycon5.png" />发布时间: <?php echo get_time($v['sendtime']); ?></code>
                    <code><img src="/public/static/images/nycon6.png" />作者:<?php echo $v['author']; ?></code>
                    <code><img src="/public/static/images/nycon7.png" />阅读:<?php echo $v['hits']; ?>次</code>
                </div>
                <div class="hzpptit3">
                ...
                <div class="hzpptit4">
                    <ul>
                        <?php if(get_prev($v['id'])): $_result=get_prev($id);if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vs): $mod = ($i % 2 );++$i;?>
                            <li><em>上一篇</em><span><a href="/index/show/index/id/<?php echo $vs['id']; ?>"><?php echo $vs['title']; ?></a></span></li>
                            <?php endforeach; endif; else: echo "" ;endif; else: ?>
                        <li><em>上一篇</em><span><a>暂无</a></span></li>
                        <?php endif; if(get_next($v['id'])): $_result=get_next($id);if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vnext): $mod = ($i % 2 );++$i;?>
                            <li><em>下一篇</em><span><a href="/index/show/index/id/<?php echo $vnext['id']; ?>"><?php echo $vnext['title']; ?></a></span></span></li>
                            <?php endforeach; endif; else: echo "" ;endif; else: ?>
                            <li><em>下一篇</em><span><a>暂无</a></span></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
