<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:36:"application/admin\view\News\Add.html";i:1588751899;s:76:"F:\phpStudy\PHPTutorial\WWW\think5\application\admin\view\Public\header.html";i:1588911510;s:74:"F:\phpStudy\PHPTutorial\WWW\think5\application\admin\view\Public\left.html";i:1588817206;s:76:"F:\phpStudy\PHPTutorial\WWW\think5\application\admin\view\Public\footer.html";i:1588130548;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    KindEditor.ready(function(K) {
		...
		<?php $__FOR_START_25697__=1;$__FOR_END_25697__=$v['imgnum'];for($i=$__FOR_START_25697__;$i < $__FOR_END_25697__;$i+=1){ ?>
	...
	<div class="layui-body">
		<div class="layui-tab layui-tab-brief" lay-filter="tab">
			<ul class="layui-tab-title">
				<li><a href="<?php echo $vs['listurl']; ?>"><?php echo $v['catname']; ?></a></li>
				<li class="layui-this"><a href="<?php echo $vs['addurl']; ?>"><?php echo $v['catname']; ?>添加</a></li>
			</ul>
					...
					<form action="" method="post" class="layui-form" lay-filter="content" id="edit">
						...
						<?php if(in_array(1,$arr)): ?>
							<div class="layui-form-item">
								...
								<?php if(in_array(3,$arr)): ?><input type="checkbox" class="checkbox" lay-skin='primary' name="isgood" value="1" title="推荐" <?php echo get_my_checked($v['isgood'],1); ?>><?php endif; if(in_array(4,$arr)): ?><input type="checkbox" class="checkbox" lay-skin='primary' name="istop" value="1" title="置顶" <?php echo get_my_checked($v['istop'],1); ?>><?php endif; ?>
						...
						<?php endif; if(in_array(10,$arr)): $__FOR_START_4210__=1;$__FOR_END_4210__=$v['imgnum'];for($i=$__FOR_START_4210__;$i < $__FOR_END_4210__;$i+=1){ $zd="img$i";?>
								<div class="layui-form-item">
