<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:41:"application/index\view\service\index.html";i:1592364343;s:76:"F:\phpStudy\PHPTutorial\WWW\think5\application\index\view\public\header.html";i:1592538099;s:76:"F:\phpStudy\PHPTutorial\WWW\think5\application\index\view\public\footer.html";i:1592476974;}*/ ?>
<?php
...
<div class="container-fluid">
    <div class="content">
        <div class="title" style="margin-bottom: 60px;">服务支持</div>
    </div>
    <?php $_result=get_news(2,10,0,0,'*',20,0,'asc');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $k = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;if($k%2 == 0): ?>
            <div class="fwzctit1 fl">
                <dl>
                    <dt style="float: right;"><img src="<?php echo $v['img1']; ?>"/></dt>
                    <dd style="float: right; margin-right: 10px;">
                        <h4><img src="<?php echo $v['img2']; ?>"/><?php echo $v['title']; ?></h4>
                        <p><?php echo $v['introduce']; ?></p>
                    </dd>
                </dl>
            </div>
        <?php else: ?>
            <div class="fwzctit1 fr">
                <dl>
